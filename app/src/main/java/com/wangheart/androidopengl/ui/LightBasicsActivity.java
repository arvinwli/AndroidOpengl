 ...
 * @date 2019/3/26
 */
public class LightBasicsActivity extends BaseActivity {
...
//            vertexBuffer.position(0);
            ...
            try {
                shader = new ShaderES30(IOUtils.toString(getThis().getAssets().open("light_basics/box.vert")),
                        IOUtils.toString(getThis().getAssets().open("light_basics/box.frag")));
                shaderLight = new ShaderES30(IOUtils.toString(getThis().getAssets().open("light_basics/light.vert")),
                        IOUtils.toString(getThis().getAssets().open("light_basics/light.frag")));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
...
//            shader.setVec3("viewPos",new float[]{0.0f,0.0f,3.0f});
            shader.setVec3("viewPos",glCamera.getPosition());
